    ...
    <form id="transaction-form" action="{{ route('TambahPenjualan') }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="Tanggal_Penjualan" value="{{ date('Y-m-d') }}" disabled>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="total-box">
                    <p>Id Penjualan:
                        <strong>
                            <input type="text" id="Id_Penjualan" name="Id_Penjualan" class="form-control" value="{{ $idPenjualan }}" readonly>
                        </strong>
                    </p>
