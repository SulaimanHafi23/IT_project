...
@section('content')
    ...
    <main class="container mt-2">
        ...
        <form id="transaction-form" action="{{ route('UpdatePenjualan', $penjualan->Id_Penjualan) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row mb-3">
                <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <table class="table table-bordered product-table">
                        ...
                        <tbody id="product-table-body">
                            <!-- Menampilkan detail penjualan yang sudah ada -->
                ...
                <div class="col-md-3">
                    <div class="total-box">
                        <p>Id Penjualan:
                            <strong>
                                <input type="text" id="Id_Penjualan" name="Id_Penjualan" class="form-control"
    ...
    <script>
        ...
        function updateTotal() {
            let total = 0;
            $('#product-table-body .subtotal').each(function() {
