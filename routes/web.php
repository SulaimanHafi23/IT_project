...
// route untuk login 
Route::get('/login', [UserController::class, 'tampil'])->name('login');//mengarahkan pengguna ke tampilan login
Route::post('/login', [UserController::class, 'login'])->name('login');//menerima data login dari form dan memprosesnya untuk autentikasi

// Rute untuk Akun
Route::get('/akun', [UserController::class, 'Tampil'])->name('TampilAkun');//untuk mengambil atau membaca data dari server
Route::get('/buat/akun', [UserController::class, 'Tambah'])->name('TambahAkun');
Route::post('/buat/akun', [UserController::class, 'submit'])->name('buatAkun');//untuk menambahkan data baru ke server
Route::get('/edit-akun/{Id}', [UserController::class, 'Edit'])->name('EditAkun');
Route::put('/update-akun/{Id}', [UserController::class, 'update'])->name('UpdateAkun');//memperbarui data yang sudah ada di server
